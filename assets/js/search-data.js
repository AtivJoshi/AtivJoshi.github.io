...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
    ...
    },{id: "news-graduated-from-ahmedabad-university-and-joined-cmi-as-a-master-s-student",
          title: 'Graduated from Ahmedabad University and joined CMI as a Master’s student.',
          description: "",
          section: "News",},{id: "news-joined-as-a-research-assistant-at-the-learning-and-networks-group-tifr",
          title: 'Joined as a Research Assistant at the Learning and Networks Group, TIFR.',
          description: "",
          section: "News",},{id: "news-our-paper-on-universal-caching-has-been-accepted-to-itw-2022",
          title: 'Our paper on Universal Caching has been accepted to ITW 2022.',
          description: "",
          section: "News",},{id: "news-started-phd-at-manning-cics-umass-amherst",
          title: 'Started PhD at Manning CICS, UMass Amherst.',
          description: "",
          section: "News",},{id: "news-our-paper-on-no-regret-algorithms-for-fair-resource-allocation-has-been-accepted-to-neurips-2023",
          title: 'Our paper on No-regret Algorithms for Fair Resource Allocation has been accepted to...',
          description: "",
          section: "News",},{id: "news-our-paper-on-online-caching-in-tree-networks-algorithms-regret-and-complexity-has-been-accepted-to-l4dc",
          title: 'Our paper on Online Caching in Tree Networks: Algorithms, Regret, and Complexity has...',
          description: "",
          section: "News",},{id: "news-our-paper-on-learning-to-allocate-reusable-resources-under-stochastic-rewards-and-durations-has-been-accepted-to-sigmetrics-26",
          title: 'Our paper on Learning to Allocate Reusable Resources under Stochastic Rewards and Durations...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%61%74%69%76%73%63@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/AtivJoshi", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/ativ-joshi", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=yNtPhSYAAAAJ", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/ativsc", "_blank");
        },
        ...
        section: "Notes",
        handler: () => {
          window.location.href = "/notes/Consciousness/";
        },
      },{id: "note-god",
        title: "god",
        description: "",
        section: "Notes",
        handler: () => {
          window.location.href = "/notes/God/";
        },
      },{id: "note-ultimate-truths",
        title: "Ultimate Truths",
        description: "",
        section: "Notes",
        handler: () => {
          window.location.href = "/notes/Ultimate%20Truths/";
        },
      },{id: "note-musings",
        title: "musings",
        description: "",
        section: "Notes",
        handler: () => {
          window.location.href = "/notes/musings/";
        },
      },{
      id: 'light-theme',
